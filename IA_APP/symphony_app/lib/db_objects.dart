...
final song1 = Song(
    songName: 'Tum ho', imglocation: 'assets/rockstar.jpg', detail: 'Rockstar');
final song2 = Song(
    songName: 'Maahi Ve', imglocation: 'assets/highway.jpg', detail: 'Highway');
final song3 = Song(
    songName: 'All of me',
    imglocation: 'assets/null.webp',
    detail: 'John Legend');
final song4 = Song(
    songName: 'Roobaroo',
    imglocation: 'assets/rangde.jpg',
    detail: 'Rand De Basanti');

final podcast1 = Song(
    songName: 'Dream With Your Eyes Open',
    imglocation: 'assets/dream.jpg',
    detail: 'By Anonymous speaker');
final podcast2 = Song(
    songName: 'Purpose',
    imglocation: 'assets/purpose.png',
    detail: 'By Gaur Gopal Das');
final podcast3 = Song(
    songName: 'Murder Mystery',
    imglocation: 'assets/murder.jpg',
    detail: 'By Saurabh');
final podcast4 = Song(
    songName: 'Girl In Space',
    imglocation: 'assets/girl.jpg',
    detail: 'By Anonymous speaker');

final poster1 = Song(
    songName: 'Kar Gayi Chull',
    imglocation: 'assets/kas.jpg',
    detail: 'Kapoor & Sons');
final poster2 = Song(
